...
class Spider(object):
    ...
    def get_params(self, page):
        ...
        data = 'param={"cityId":102,"cateCode":"2","cateId":"10","dispCateId":"10","dispLocalId":102,"pageNum":%s,"key":"","queryList":{},"thirdKey":"%s"}&thirdKey=%s&appCode=0'
    ...
    def get_content(self, next_page, proxy):
        ...
        try:
            print("正在请求第{0}页".format(next_page))
            r = requests.post(url, data=data, headers=headers, proxies=proxies)
        except requests.ConnectionError as e:
            print("请求第{0}页失败".format(next_page), e)
            return False
